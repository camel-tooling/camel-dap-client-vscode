...
// 	public createRunTaskOnContainingFolder() {
// 		const shellExecOptions: ShellExecutionOptions = {
// 			cwd: "${fileDirname}"
// 		};
...
// 		const runTask = new Task(
// 			{
// 				label: CamelJBangTaskProvider.labelProvidedRunAllFromContainingFolderTask,
// 				type: "shell",
// 				runOptions: {
...
// 			},
// 			TaskScope.Workspace,
// 			CamelJBangTaskProvider.labelProvidedRunAllFromContainingFolderTask,
// 			'camel',
// 			new ShellExecution(
// 				// 'pwd',
// 				// ['-P'].filter(function (arg) { return arg; }),
// //				'cd ${fileDirname} && jbang -Dcamel.jbang.version=' + this.getCamelJBangCLIVersion() + ' camel@apache/camel run * --dev --logging-level=info',
// 				'jbang',
// 				[
// 					{
// 						"value": `-Dcamel.jbang.version=${this.getCamelJBangCLIVersion()}`,
